<%@ Page Language="VB" MasterPageFile="~/MasterPage6.master" AutoEventWireup="false" CodeFile="Default13.aspx.vb" Inherits="Default12" title="未命名頁面" %>
...
<div style="margin-top:10px">
<div class="section">虛擬貨幣扣款資訊</div>
                                        <asp:FormView ID="FormView2" runat="server" DataKeyNames="id" 
                                            ...
                                            <ItemTemplate>
                                                目前擁有的虛擬貨幣： 
                                                <asp:Label ID="m_pointLabel" runat="server" Text='<%# Eval("m_point") %>' />
                                                <br />
                                                交易扣款：<asp:Label ID="Label1" runat="server" Text=""></asp:Label>
                                                <br />
                                                ______________________________<br />
                                                交易後餘額：<asp:Label ID="Label2" runat="server" Text=""></asp:Label>
                                                <br />
                                            </ItemTemplate>
                                        </asp:FormView>
                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                            ConnectionString="<%$ ConnectionStrings:DB_RentConnectionString2 %>" 
                                            SelectCommand="SELECT * FROM [member_data]"></asp:SqlDataSource>
</div>
</div>
<div class="rinframe">
<div class="section">安全小提醒</div>
<div>
    請確認你的賣家，並不會指示你額外付費，以免受騙。</div>
</div>
</div>
...
租借商品資訊
    ...
    <br />
    <asp:FormView ID="FormView3" runat="server" DataKeyNames="com_id" 
        DataSourceID="SqlDataSource1">
        <EditItemTemplate>
            com_id:
            <asp:Label ID="com_idLabel1" runat="server" Text='<%# Eval("com_id") %>' />
